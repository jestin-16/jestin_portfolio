  ...
  return (
    <motion.div
      ...
      className={`relative cursor-pointer flex flex-col items-center justify-center w-14 h-14 sm:w-16 sm:h-16 p-2 rounded-2xl transition-all duration-300 backdrop-blur-md ${
        isHovered
          ? "bg-emerald-500/15 border border-emerald-400/60 shadow-[0_0_22px_rgba(16,185,129,0.3)] z-30 scale-110"
          : "bg-[#0e1017]/80 border border-white/[0.08] hover:border-emerald-500/35 hover:bg-emerald-950/20 hover:shadow-[0_0_14px_rgba(16,185,129,0.2)]"
      }`}
    >
      {/* Subtle corner dot */}
      <div
          ...
          <img
            ...
            style={{
              filter: isHovered
                ...
                : "brightness(0) saturate(100%) invert(58%) sepia(50%) saturate(460%) hue-rotate(110deg) brightness(96%) contrast(92%)",
      ...
      {/* Minimal Label */}
      <span className="mt-1 text-[9px] sm:text-[10px] font-sans font-medium text-neutral-300 group-hover:text-white truncate max-w-[56px] text-center leading-tight">
        {item.name}
      </span>
    </motion.div>
  );
...
export default function TechStack() {
  return (
    ...
    >
      {/* Radiant Matching Emerald Mesh & Grid Background */}
      <div className="absolute inset-0 pointer-events-none">
        {/* Central soft glowing emerald sphere */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[550px] sm:w-[800px] h-[550px] sm:h-[800px] bg-emerald-500/10 rounded-full blur-[170px]" />
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-[260px] bg-gradient-to-b from-emerald-500/10 via-emerald-500/3 to-transparent blur-3xl" />
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto space-y-10">
        ...
        <div className="text-center space-y-3">
          <motion.div
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-xs font-mono uppercase tracking-widest shadow-[0_0_12px_rgba(16,185,129,0.18)]"
          >
          ...
          <motion.h2
            ...
            className="text-4xl sm:text-6xl font-display font-black tracking-tight text-white uppercase bg-clip-text text-transparent bg-gradient-to-b from-white via-neutral-100 to-emerald-300 drop-shadow-[0_0_20px_rgba(16,185,129,0.2)]"
          >
            TECH STACK
          </motion.h2>
        </div>
