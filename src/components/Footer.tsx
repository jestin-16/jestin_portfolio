...
export default function Footer({ onNavigate }: FooterProps) {
  ...
  return (
    <footer className="relative bg-[#0a0b0e] text-neutral-300 border-t border-white/[0.08] select-none font-sans overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12 pt-14 pb-10 relative z-10 space-y-12">
        ...
        <div className="p-6 md:p-8 rounded-2xl bg-gradient-to-r from-white/[0.03] via-white/[0.015] to-transparent border border-white/[0.08] backdrop-blur-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-6 shadow-[0_10px_30px_rgba(0,0,0,0.3)]">
          ...
          <div className="flex flex-wrap items-center gap-3 shrink-0 w-full md:w-auto">
            <button
              ...
              className="flex-1 md:flex-none inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-[#0a0b0e] font-display font-semibold text-xs sm:text-sm transition-all shadow-[0_0_25px_rgba(16,185,129,0.3)] hover:shadow-[0_0_35px_rgba(16,185,129,0.5)] cursor-pointer active:scale-95"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 pb-10 border-b border-white/[0.06]">
          ...
          <div className="md:col-span-4 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="text-base font-display font-bold text-white tracking-tight leading-tight">
                  Jestin Shaji
                </h4>
          ...
          <div className="md:col-span-3 space-y-3">
            <h5 className="text-xs font-mono font-bold uppercase tracking-wider text-neutral-300 flex items-center gap-2">
            ...
            <div className="grid grid-cols-2 gap-y-2 text-xs font-sans">
              {navLinks.map((link) => (
                <button
                  ...
                  className="group text-left text-neutral-400 hover:text-white transition-colors cursor-pointer flex items-center gap-1.5 py-0.5"
                >
                  <span className="text-emerald-500/40 group-hover:text-emerald-400 transition-colors">&rsaquo;</span>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-neutral-400 font-sans pt-2">
          ...
          <div className="flex items-center gap-2 font-mono text-[11px] text-neutral-400 bg-white/[0.02] px-3 py-1 rounded-full border border-white/[0.05]">
            <ShieldCheck className="w-3.5 h-3.5 text-emerald-400" />
            <span>Clean Architecture &bull; Spring Boot 3 &bull; React</span>
          </div>
