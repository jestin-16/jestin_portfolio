    ...
    <section id="services" className="py-24 px-6 md:px-12 bg-gradient-to-b from-[#010104] to-[#04040d] relative overflow-hidden border-t border-white/[0.04] select-none">
      ...
      <div className="max-w-7xl mx-auto text-center space-y-4 mb-16">
        <motion.h2
          ...
          className="text-4xl sm:text-5xl font-heading font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-white via-cyan-200 to-indigo-300 text-glow"
        >
          Services
        </motion.h2>
        <motion.p
